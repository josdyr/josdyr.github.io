var Typer = function(element) {
  ...
  //added
  this.delayBackwards = element.dataset.delayBackwards || 40;
  //added
  this.deleteDelayPause = element.dataset.deleteDelayPause || 1300;
  this.loop = element.dataset.loop || "true";
  this.deleteDelay = element.dataset.deletedelay || element.dataset.deleteDelay || 2000;

  this.progress = { word:0, char:0, building:true, atWordEnd:false, atWordBegin:true, looped: 0 };
  this.typing = true;
  //added
  this.typingBackwards = false;
  //added
...
Typer.prototype.doTyping = function() {
  ...
  if (p.building) {
    ...
    if (p.char == 0) {
      ...
      this.counterPause = this.counterPause ? false : true;
      p.atWordBegin = true;
      //
      p.building = true;
  ...
  //modified
  }, p.atWordEnd ? this.deleteDelay : ( p.atWordBegin ? this.deleteDelayPause : (this.typingBackwards ? this.delayBackwards : this.delay)));
};
